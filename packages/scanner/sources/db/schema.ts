...
export interface QueryRequest {
  ...
  block?: [{ hash?: ID | null; number?: Long | null }, BlockRequest] | BlockRequest
  /** Find a document from the collection of 'Cursor' by its id. */
  findCursorByID?: [
    {
...
export const isERC721ImportResultPage = (obj: { __typename: String }): obj is ERC721ImportResultPage => {
  if (!obj.__typename) throw new Error('__typename is missing')
...
export const isERC721ImportResult = (obj: { __typename: String }): obj is ERC721ImportResult => {
  if (!obj.__typename) throw new Error('__typename is missing')
...
export const isTokenAsset = (obj: { __typename: String }): obj is TokenAsset => {
  if (!obj.__typename) throw new Error('__typename is missing')
...
export const isResourcePage = (obj: { __typename: String }): obj is ResourcePage => {
  if (!obj.__typename) throw new Error('__typename is missing')
...
export const isTokenContract = (obj: { __typename: String }): obj is TokenContract => {
  if (!obj.__typename) throw new Error('__typename is missing')
...
export interface QueryPromiseChain {
  ...
  findOwnerByID: (args: {
    /** The 'Owner' document's ID */
    id: ID
  }) => OwnerPromiseChain & { execute: (request: OwnerRequest, defaultValue?: Owner | null) => Promise<Owner | null> }
  /** Find a document from the collection of 'ERC721ImportResult' by its id. */
  ...
  cursor: CursorPromiseChain & { execute: (request: CursorRequest, defaultValue?: Cursor) => Promise<Cursor> }
  /** Find a document from the collection of 'Metadata' by its id. */
  findMetadataByID: (args: {
    /** The 'Metadata' document's ID */
    id: ID
  }) => MetadataPromiseChain & {
    execute: (request: MetadataRequest, defaultValue?: Metadata | null) => Promise<Metadata | null>
  }
  /** Find a document from the collection of 'Task' by its id. */
  findTaskByID: (args: {
    /** The 'Task' document's ID */
    id: ID
  }) => TaskPromiseChain & { execute: (request: TaskRequest, defaultValue?: Task | null) => Promise<Task | null> }
  block: ((args?: {
    hash?: ID | null
    number?: Long | null
  }) => BlockPromiseChain & { execute: (request: BlockRequest, defaultValue?: Block | null) => Promise<Block | null> }) &
  ...
  findTokenAssetByID: (args: {
    ...
    execute: (request: TokenAssetRequest, defaultValue?: TokenAsset | null) => Promise<TokenAsset | null>
  }
  tokens: ((args?: {
    /** The number of items to return per page. */
    _size?: Int | null
    ...
    tokenID?: String | null
    mintTime?: String | null
  }) => TokenPagePromiseChain & { execute: (request: TokenPageRequest, defaultValue?: TokenPage) => Promise<TokenPage> }) &
    (TokenPagePromiseChain & { execute: (request: TokenPageRequest, defaultValue?: TokenPage) => Promise<TokenPage> })
  owner: ((args?: {
    id?: ID | null
  }) => OwnerPromiseChain & { execute: (request: OwnerRequest, defaultValue?: Owner | null) => Promise<Owner | null> }) &
...
export interface QueryObservableChain {
  ...
  findOwnerByID: (args: {
    /** The 'Owner' document's ID */
    id: ID
  }) => OwnerObservableChain & { execute: (request: OwnerRequest, defaultValue?: Owner | null) => Observable<Owner | null> }
  /** Find a document from the collection of 'ERC721ImportResult' by its id. */
  findERC721ImportResultByID: (args: {
    /** The 'ERC721ImportResult' document's ID */
    id: ID
  ...
  cursor: CursorObservableChain & { execute: (request: CursorRequest, defaultValue?: Cursor) => Observable<Cursor> }
  /** Find a document from the collection of 'Metadata' by its id. */
  findMetadataByID: (args: {
    /** The 'Metadata' document's ID */
    id: ID
  }) => MetadataObservableChain & {
    execute: (request: MetadataRequest, defaultValue?: Metadata | null) => Observable<Metadata | null>
  }
  /** Find a document from the collection of 'Task' by its id. */
  findTaskByID: (args: {
    /** The 'Task' document's ID */
    id: ID
  }) => TaskObservableChain & { execute: (request: TaskRequest, defaultValue?: Task | null) => Observable<Task | null> }
  block: ((args?: {
    hash?: ID | null
    number?: Long | null
  }) => BlockObservableChain & {
    execute: (request: BlockRequest, defaultValue?: Block | null) => Observable<Block | null>
  }) &
    (BlockObservableChain & { execute: (request: BlockRequest, defaultValue?: Block | null) => Observable<Block | null> })
  /** Find a document from the collection of 'Cursor' by its id. */
  findCursorByID: (args: {
  ...
  findTokenAssetByID: (args: {
    ...
    execute: (request: TokenAssetRequest, defaultValue?: TokenAsset | null) => Observable<TokenAsset | null>
  }
  tokens: ((args?: {
    /** The number of items to return per page. */
    _size?: Int | null
    ...
    execute: (request: TokenPageRequest, defaultValue?: TokenPage) => Observable<TokenPage>
  }) &
  ...
  owner: ((args?: {
    ...
    execute: (request: OwnerRequest, defaultValue?: Owner | null) => Observable<Owner | null>
  }) &
    (OwnerObservableChain & { execute: (request: OwnerRequest, defaultValue?: Owner | null) => Observable<Owner | null> })
  allTokens: ((args?: {
    /** The number of items to return per page. */
...
export interface BlockPromiseChain {
  /** The block number */
  number: { execute: (request?: boolean | number, defaultValue?: Long) => Promise<Long> }
  /** The document's ID. */
  _id: { execute: (request?: boolean | number, defaultValue?: ID) => Promise<ID> }
  /** The hash of the block */
  hash: { execute: (request?: boolean | number, defaultValue?: ID) => Promise<ID> }
  tokens: ((args?: {
    /** The number of items to return per page. */
    _size?: Int | null
    /** The pagination cursor. */
...
export interface BlockObservableChain {
  /** The block number */
  number: { execute: (request?: boolean | number, defaultValue?: Long) => Observable<Long> }
  /** The document's ID. */
  _id: { execute: (request?: boolean | number, defaultValue?: ID) => Observable<ID> }
  /** The hash of the block */
  hash: { execute: (request?: boolean | number, defaultValue?: ID) => Observable<ID> }
  tokens: ((args?: {
    /** The number of items to return per page. */
    _size?: Int | null
    /** The pagination cursor. */
...
export interface TokenPagePromiseChain {
  /** The elements of type 'Token' in this page. */
  data: { execute: (request: TokenRequest, defaultValue?: (Token | null)[]) => Promise<(Token | null)[]> }
  /** A cursor for elements coming after the current page. */
...
export interface TokenPageObservableChain {
  /** The elements of type 'Token' in this page. */
  data: { execute: (request: TokenRequest, defaultValue?: (Token | null)[]) => Observable<(Token | null)[]> }
  /** A cursor for elements coming after the current page. */
...
export interface TokenPromiseChain {
  blocks: ((args?: {
    ...
    /** The pagination cursor. */
    _cursor?: String | null
  }) => BlockPagePromiseChain & { execute: (request: BlockPageRequest, defaultValue?: BlockPage) => Promise<BlockPage> }) &
    (BlockPagePromiseChain & { execute: (request: BlockPageRequest, defaultValue?: BlockPage) => Promise<BlockPage> })
  /** The document's ID. */
  _id: { execute: (request?: boolean | number, defaultValue?: ID) => Promise<ID> }
  mintTime: { execute: (request?: boolean | number, defaultValue?: String) => Promise<String> }
  ...
  owner: OwnerPromiseChain & { execute: (request: OwnerRequest, defaultValue?: Owner) => Promise<Owner> }
  /** Present when ERC721Metadata interface is implemented. */
  tokenAsset: TokenAssetPromiseChain & {
    execute: (request: TokenAssetRequest, defaultValue?: TokenAsset | null) => Promise<TokenAsset | null>
  }
  contract: TokenContractPromiseChain & {
    execute: (request: TokenContractRequest, defaultValue?: TokenContract) => Promise<TokenContract>
  }
  /** The document's timestamp. */
  _ts: { execute: (request?: boolean | number, defaultValue?: Long) => Promise<Long> }
}
...
export interface TokenObservableChain {
  blocks: ((args?: {
    ...
    execute: (request: BlockPageRequest, defaultValue?: BlockPage) => Observable<BlockPage>
  }) &
    (BlockPageObservableChain & { execute: (request: BlockPageRequest, defaultValue?: BlockPage) => Observable<BlockPage> })
  /** The document's ID. */
  _id: { execute: (request?: boolean | number, defaultValue?: ID) => Observable<ID> }
  mintTime: { execute: (request?: boolean | number, defaultValue?: String) => Observable<String> }
  ...
  owner: OwnerObservableChain & { execute: (request: OwnerRequest, defaultValue?: Owner) => Observable<Owner> }
  /** Present when ERC721Metadata interface is implemented. */
  tokenAsset: TokenAssetObservableChain & {
    execute: (request: TokenAssetRequest, defaultValue?: TokenAsset | null) => Observable<TokenAsset | null>
  }
  contract: TokenContractObservableChain & {
    execute: (request: TokenContractRequest, defaultValue?: TokenContract) => Observable<TokenContract>
  }
  /** The document's timestamp. */
  _ts: { execute: (request?: boolean | number, defaultValue?: Long) => Observable<Long> }
}
...
export interface BlockPagePromiseChain {
  /** The elements of type 'Block' in this page. */
  data: { execute: (request: BlockRequest, defaultValue?: (Block | null)[]) => Promise<(Block | null)[]> }
  /** A cursor for elements coming after the current page. */
  after: { execute: (request?: boolean | number, defaultValue?: String | null) => Promise<String | null> }
  /** A cursor for elements coming before the current page. */
  before: { execute: (request?: boolean | number, defaultValue?: String | null) => Promise<String | null> }
...
export interface BlockPageObservableChain {
  /** The elements of type 'Block' in this page. */
  data: { execute: (request: BlockRequest, defaultValue?: (Block | null)[]) => Observable<(Block | null)[]> }
  /** A cursor for elements coming after the current page. */
  after: { execute: (request?: boolean | number, defaultValue?: String | null) => Observable<String | null> }
  /** A cursor for elements coming before the current page. */
  before: { execute: (request?: boolean | number, defaultValue?: String | null) => Observable<String | null> }
...
export interface ERC721ImportResultPromiseChain {
  ...
  _id: { execute: (request?: boolean | number, defaultValue?: ID) => Promise<ID> }
  /** New cursor after this import. */
  nextID: { execute: (request?: boolean | number, defaultValue?: String) => Promise<String> }
  /** Cursor from which import started. */
  id: { execute: (request?: boolean | number, defaultValue?: String) => Promise<String> }
  /** Tokens that were imported. */
  tokens: ((args?: {
...
export interface ERC721ImportResultObservableChain {
  ...
  _id: { execute: (request?: boolean | number, defaultValue?: ID) => Observable<ID> }
  /** New cursor after this import. */
  nextID: { execute: (request?: boolean | number, defaultValue?: String) => Observable<String> }
  /** Cursor from which import started. */
  id: { execute: (request?: boolean | number, defaultValue?: String) => Observable<String> }
  /** Tokens that were imported. */
  tokens: ((args?: {
...
export interface TokenAssetPromiseChain {
   ...
   * Present when it was passibly to succesfully pin the token.
   */
  ipnft: { execute: (request?: boolean | number, defaultValue?: String | null) => Promise<String | null> }
  /**
   * Multiple tokens may have use a same `tokenURI`. This relation allows tracking
   * which tokens refer to the same `tokenURI`.
   * Token this metadata belogs to.
...
export interface TokenAssetObservableChain {
   ...
   * Present when it was passibly to succesfully pin the token.
   */
  ipnft: { execute: (request?: boolean | number, defaultValue?: String | null) => Observable<String | null> }
  /**
   * Multiple tokens may have use a same `tokenURI`. This relation allows tracking
   * which tokens refer to the same `tokenURI`.
   * Token this metadata belogs to.
...
export interface MetadataPromiseChain {
  ...
  assets: ((args?: {
    ...
    execute: (request: ResourcePageRequest, defaultValue?: ResourcePage) => Promise<ResourcePage>
  }) &
    (ResourcePagePromiseChain & {
      execute: (request: ResourcePageRequest, defaultValue?: ResourcePage) => Promise<ResourcePage>
    })
  /** A file representing the asset this token represents */
  image: ResourcePromiseChain & { execute: (request: ResourceRequest, defaultValue?: Resource) => Promise<Resource> }
  /** Describes the asset this token represents */
...
export interface MetadataObservableChain {
  ...
  assets: ((args?: {
    ...
    execute: (request: ResourcePageRequest, defaultValue?: ResourcePage) => Observable<ResourcePage>
  }) &
    (ResourcePageObservableChain & {
      execute: (request: ResourcePageRequest, defaultValue?: ResourcePage) => Observable<ResourcePage>
    })
  /** A file representing the asset this token represents */
  image: ResourceObservableChain & { execute: (request: ResourceRequest, defaultValue?: Resource) => Observable<Resource> }
  /** Describes the asset this token represents */
...
export interface ResourcePromiseChain {
  ...
  referrers: ((args?: {
    ...
    execute: (request: MetadataPageRequest, defaultValue?: MetadataPage) => Promise<MetadataPage>
  }) &
    (MetadataPagePromiseChain & {
      execute: (request: MetadataPageRequest, defaultValue?: MetadataPage) => Promise<MetadataPage>
    })
...
export interface MetadataPagePromiseChain {
  /** The elements of type 'Metadata' in this page. */
  data: { execute: (request: MetadataRequest, defaultValue?: (Metadata | null)[]) => Promise<(Metadata | null)[]> }
  /** A cursor for elements coming after the current page. */
  after: { execute: (request?: boolean | number, defaultValue?: String | null) => Promise<String | null> }
  /** A cursor for elements coming before the current page. */
  before: { execute: (request?: boolean | number, defaultValue?: String | null) => Promise<String | null> }
...
export interface MetadataPageObservableChain {
  /** The elements of type 'Metadata' in this page. */
  data: { execute: (request: MetadataRequest, defaultValue?: (Metadata | null)[]) => Observable<(Metadata | null)[]> }
  /** A cursor for elements coming after the current page. */
  after: { execute: (request?: boolean | number, defaultValue?: String | null) => Observable<String | null> }
  /** A cursor for elements coming before the current page. */
  before: { execute: (request?: boolean | number, defaultValue?: String | null) => Observable<String | null> }
...
export interface TokenContractPromiseChain {
  ...
  id: { execute: (request?: boolean | number, defaultValue?: ID) => Promise<ID> }
  supportsEIP721Metadata: { execute: (request?: boolean | number, defaultValue?: Boolean) => Promise<Boolean> }
  tokens: ((args?: {
    /** The number of items to return per page. */
    _size?: Int | null
    /** The pagination cursor. */
...
export interface TokenContractObservableChain {
  ...
  id: { execute: (request?: boolean | number, defaultValue?: ID) => Observable<ID> }
  supportsEIP721Metadata: { execute: (request?: boolean | number, defaultValue?: Boolean) => Observable<Boolean> }
  tokens: ((args?: {
    /** The number of items to return per page. */
    _size?: Int | null
    /** The pagination cursor. */
...
export interface MutationPromiseChain {
  ...
  createToken: (args: {
    /** 'Token' input values */
    data: TokenInput
  }) => TokenPromiseChain & { execute: (request: TokenRequest, defaultValue?: Token) => Promise<Token> }
  /** Delete an existing document in the collection of 'Cursor' */
  deleteCursor: (args: {
    /** The 'Cursor' document's ID */
    id: ID
  ...
  importERC721: (args: {
    ...
    execute: (request: ERC721ImportResultRequest, defaultValue?: ERC721ImportResult) => Promise<ERC721ImportResult>
  }
  /** Update an existing document in the collection of 'TokenContract' */
  ...
  createCursor: (args: {
    /** 'Cursor' input values */
    data: CursorInput
  }) => CursorPromiseChain & { execute: (request: CursorRequest, defaultValue?: Cursor) => Promise<Cursor> }
  /** Create a new document in the collection of 'Task' */
  createTask: (args: {
    /** 'Task' input values */
    data: TaskInput
  }) => TaskPromiseChain & { execute: (request: TaskRequest, defaultValue?: Task) => Promise<Task> }
  /** Update an existing document in the collection of 'Token' */
  updateToken: (args: {
    /** The 'Token' document's ID */
    id: ID
  ...
  createOwner: (args: {
    /** 'Owner' input values */
    data: OwnerInput
  }) => OwnerPromiseChain & { execute: (request: OwnerRequest, defaultValue?: Owner) => Promise<Owner> }
  /** Update an existing document in the collection of 'Resource' */
  updateResource: (args: {
    /** The 'Resource' document's ID */
    id: ID
...
export interface MutationObservableChain {
  ...
  createToken: (args: {
    /** 'Token' input values */
    data: TokenInput
  }) => TokenObservableChain & { execute: (request: TokenRequest, defaultValue?: Token) => Observable<Token> }
  /** Delete an existing document in the collection of 'Cursor' */
  deleteCursor: (args: {
    /** The 'Cursor' document's ID */
    id: ID
  ...
  importERC721: (args: {
    ...
    execute: (request: ERC721ImportResultRequest, defaultValue?: ERC721ImportResult) => Observable<ERC721ImportResult>
  }
  /** Update an existing document in the collection of 'TokenContract' */
  updateTokenContract: (args: {
    /** The 'TokenContract' document's ID */
  ...
  createCursor: (args: {
    /** 'Cursor' input values */
    data: CursorInput
  }) => CursorObservableChain & { execute: (request: CursorRequest, defaultValue?: Cursor) => Observable<Cursor> }
  /** Create a new document in the collection of 'Task' */
  createTask: (args: {
    /** 'Task' input values */
    data: TaskInput
  }) => TaskObservableChain & { execute: (request: TaskRequest, defaultValue?: Task) => Observable<Task> }
  /** Update an existing document in the collection of 'Token' */
  updateToken: (args: {
    /** The 'Token' document's ID */
    id: ID
  ...
  createOwner: (args: {
    /** 'Owner' input values */
    data: OwnerInput
  }) => OwnerObservableChain & { execute: (request: OwnerRequest, defaultValue?: Owner) => Observable<Owner> }
  /** Update an existing document in the collection of 'Resource' */
  updateResource: (args: {
    /** The 'Resource' document's ID */
    id: ID
