...
export const isOwnerPerTokenContract = (obj: { __typename: String }): obj is OwnerPerTokenContract => {
  if (!obj.__typename) throw new Error('__typename is missing')
...
export interface QueryPromiseChain {
  all: (args: {
    ...
    /** The block at which the query should be executed. Can either be an `{ number: Int }` containing the block number or a `{ hash: Bytes }` value containing a block hash. Defaults to the latest block when omitted. */
    block?: Block_height | null
  }) => AllPromiseChain & { execute: (request: AllRequest, defaultValue?: All | null) => Promise<All | null> }
  alls: ((args?: {
    skip?: Int | null
    first?: Int | null
    orderBy?: All_orderBy | null
  ...
  _meta: ((args?: {
    block?: Block_height | null
  }) => _Meta_PromiseChain & { execute: (request: _Meta_Request, defaultValue?: _Meta_ | null) => Promise<_Meta_ | null> }) &
    (_Meta_PromiseChain & { execute: (request: _Meta_Request, defaultValue?: _Meta_ | null) => Promise<_Meta_ | null> })
}
...
export interface QueryObservableChain {
  all: (args: {
    ...
    /** The block at which the query should be executed. Can either be an `{ number: Int }` containing the block number or a `{ hash: Bytes }` value containing a block hash. Defaults to the latest block when omitted. */
    block?: Block_height | null
  }) => AllObservableChain & { execute: (request: AllRequest, defaultValue?: All | null) => Observable<All | null> }
  alls: ((args?: {
    skip?: Int | null
    first?: Int | null
    orderBy?: All_orderBy | null
  ...
  _meta: ((args?: {
    ...
    execute: (request: _Meta_Request, defaultValue?: _Meta_ | null) => Observable<_Meta_ | null>
  }) &
    (_Meta_ObservableChain & {
      execute: (request: _Meta_Request, defaultValue?: _Meta_ | null) => Observable<_Meta_ | null>
    })
...
export interface AllPromiseChain {
  ...
  numTokenContracts: { execute: (request?: boolean | number, defaultValue?: BigInt) => Promise<BigInt> }
  numTokens: { execute: (request?: boolean | number, defaultValue?: BigInt) => Promise<BigInt> }
  numOwners: { execute: (request?: boolean | number, defaultValue?: BigInt) => Promise<BigInt> }
}

export interface AllObservableChain {
  id: { execute: (request?: boolean | number, defaultValue?: ID) => Observable<ID> }
  numTokenContracts: { execute: (request?: boolean | number, defaultValue?: BigInt) => Observable<BigInt> }
  numTokens: { execute: (request?: boolean | number, defaultValue?: BigInt) => Observable<BigInt> }
  numOwners: { execute: (request?: boolean | number, defaultValue?: BigInt) => Observable<BigInt> }
}
...
export interface TokenPromiseChain {
  ...
  tokenID: { execute: (request?: boolean | number, defaultValue?: BigInt) => Promise<BigInt> }
  owner: OwnerPromiseChain & { execute: (request: OwnerRequest, defaultValue?: Owner) => Promise<Owner> }
  mintTime: { execute: (request?: boolean | number, defaultValue?: BigInt) => Promise<BigInt> }
  tokenURI: { execute: (request?: boolean | number, defaultValue?: String) => Promise<String> }
  blockNumber: { execute: (request?: boolean | number, defaultValue?: BigInt) => Promise<BigInt> }
  blockHash: { execute: (request?: boolean | number, defaultValue?: Bytes) => Promise<Bytes> }
}
...
export interface TokenObservableChain {
  ...
  tokenID: { execute: (request?: boolean | number, defaultValue?: BigInt) => Observable<BigInt> }
  owner: OwnerObservableChain & { execute: (request: OwnerRequest, defaultValue?: Owner) => Observable<Owner> }
  mintTime: { execute: (request?: boolean | number, defaultValue?: BigInt) => Observable<BigInt> }
  tokenURI: { execute: (request?: boolean | number, defaultValue?: String) => Observable<String> }
  blockNumber: { execute: (request?: boolean | number, defaultValue?: BigInt) => Observable<BigInt> }
  blockHash: { execute: (request?: boolean | number, defaultValue?: Bytes) => Observable<Bytes> }
}
...
export interface TokenContractPromiseChain {
  ...
  doAllAddressesOwnTheirIdByDefault: { execute: (request?: boolean | number, defaultValue?: Boolean) => Promise<Boolean> }
...
export interface TokenContractObservableChain {
  ...
  doAllAddressesOwnTheirIdByDefault: { execute: (request?: boolean | number, defaultValue?: Boolean) => Observable<Boolean> }
...
export interface _Meta_PromiseChain {
   ...
   *
   */
  block: _Block_PromiseChain & { execute: (request: _Block_Request, defaultValue?: _Block_) => Promise<_Block_> }
  /** The deployment ID */
  deployment: { execute: (request?: boolean | number, defaultValue?: String) => Promise<String> }
  /** If `true`, the subgraph encountered indexing errors at some past block */
  hasIndexingErrors: { execute: (request?: boolean | number, defaultValue?: Boolean) => Promise<Boolean> }
}
...
export interface _Meta_ObservableChain {
   ...
   *
   */
  block: _Block_ObservableChain & { execute: (request: _Block_Request, defaultValue?: _Block_) => Observable<_Block_> }
  /** The deployment ID */
  deployment: { execute: (request?: boolean | number, defaultValue?: String) => Observable<String> }
  /** If `true`, the subgraph encountered indexing errors at some past block */
  hasIndexingErrors: { execute: (request?: boolean | number, defaultValue?: Boolean) => Observable<Boolean> }
}

export interface _Block_PromiseChain {
  /** The hash of the block */
  hash: { execute: (request?: boolean | number, defaultValue?: Bytes | null) => Promise<Bytes | null> }
  /** The block number */
  number: { execute: (request?: boolean | number, defaultValue?: Int) => Promise<Int> }
}

export interface _Block_ObservableChain {
  /** The hash of the block */
  hash: { execute: (request?: boolean | number, defaultValue?: Bytes | null) => Observable<Bytes | null> }
  /** The block number */
  number: { execute: (request?: boolean | number, defaultValue?: Int) => Observable<Int> }
}
